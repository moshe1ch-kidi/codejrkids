...
export const SHAPE_CATEGORIES: ShapeCategory[] = [
  ...
  },
  {
    ...
    title: 'Animals & Fun',
    shapes: [
      { id: 'cat', name: 'Cat Face', path: 'M 25 35 Q 20 10 35 25 Q 50 15 65 25 Q 80 10 75 35 Q 90 50 90 70 Q 90 90 50 90 Q 10 90 10 70 Q 10 50 25 35 Z M 35 45 A 5 5 0 1 0 35 55 A 5 5 0 0 0 35 45 Z M 65 45 A 5 5 0 1 0 65 55 A 5 5 0 0 0 65 45 Z M 50 65 Q 45 70 50 75 Q 55 70 50 65 Z' },
      { id: 'crown', name: 'Crown', path: 'M 10 80 H 90 L 100 30 L 75 55 L 50 15 L 25 55 L 0 30 Z M 10 90 H 90 V 98 H 10 Z' },
      { id: 'music', name: 'Music Note', path: 'M 30 70 A 15 15 0 1 1 30 40 V 10 H 90 V 40 A 15 15 0 1 1 90 70 V 50 H 30 Z' },
      { id: 'shield', name: 'Shield', path: 'M 50 0 L 100 20 V 50 C 100 80 75 95 50 100 C 25 95 0 80 0 50 V 20 Z' },
      { id: 'trophy', name: 'Trophy', path: 'M 30 10 H 70 V 40 C 70 60 55 70 55 70 V 85 H 65 V 95 H 35 V 85 H 45 V 70 C 45 70 30 60 30 40 Z M 15 20 H 30 V 40 C 20 40 15 30 15 20 Z M 85 20 H 70 V 40 C 80 40 85 30 85 20 Z' },
    ],
  },
  {
    id: 'symbols',
