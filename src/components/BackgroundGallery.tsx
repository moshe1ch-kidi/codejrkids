...
const ALL_BACKGROUNDS = [
  { id: 'Playroom', name: 'Playroom', file: '01_cheder_mischakim_640x480.svg', displayName: 'Playroom' },
  { id: 'Beach', name: 'Beach', file: '02_chof_yam_640x480.svg', displayName: 'Beach' },
  { id: 'Space', name: 'Space', file: '03_chalal_640x480.svg', displayName: 'Space' },
  { id: 'UrbanStreet', name: 'UrbanStreet', file: '04_rechov_ironi_640x480.svg', displayName: 'Urban Street' },
  { id: 'MagicForest', name: 'MagicForest', file: '05_yaar_kasum_640x480.svg', displayName: 'Magic Forest' },
  { id: 'CandyKingdom', name: 'CandyKingdom', file: '06_mamlechet_mamtakim_640x480.svg', displayName: 'Candy Kingdom' },
  { id: 'ScienceLab', name: 'ScienceLab', file: '07_maabada_madait_640x480.svg', displayName: 'Science Lab' },
  { id: 'AncientCastle', name: 'AncientCastle', file: '08_tira_atika_640x480.svg', displayName: 'Ancient Castle' },
  { id: 'OceanFloor', name: 'OceanFloor', file: '09_karkait_hayam_640x480.svg', displayName: 'Ocean Floor' },
  { id: 'Volcano', name: 'Volcano', file: '10_har_gaash_640x480.svg', displayName: 'Volcano' },
